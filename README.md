...
A modern, terminal-style web application for VIT students to monitor attendance, timetable, and academic performance by syncing data from the VIERP portal. Features real-time analysis, AI-powered chat assistance, dashboard views, simulator, and settings with progress tracking.
